<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="RegVtas.aspx.cs" Inherits="SanAlberto.pages.vtas.RegVtasAnti" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="d-sm-flex align-items-center justify-content-center mb-2">
        <h1 class="h3 mb-0 mt-0 text-gray-800 font-weight-bolder">Registro de Ventas Anticipadas
    ...
    <div id="listaoc">
        <div class="row">
            <div class="col-12 col-lg-7">
                ...
                <div class="row">
                    <label>Lista de Importaciones / Stock  de productos</label>
            ...
            <div class="stickyTable col-12 col-lg-5 table-responsive table-responsive-sm" style="height:65vh;">
                ...
                <div class="row stickyTable table-responsive table-responsive-sm" >
                    <label>Lista de Pedidos - Venta Anticipada</label>
                    <div id="infoventanti" class="col-12 " >
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-md-8">
                <div class="row">
                    ...
                    <div class="col-6 col-md-3 form-group">
                        <label class="my-0">Forma de Pago</label>
    ...
    <div id="formae" style="display: none">
    <div class="row">
        <div class="col-md-3 col-6">
            <div class="form-check">
                <label class="form-check-label">
    ...
    <div class="row">
      <input class="form-control form-control-sm" type="text" id="idvent" style="display: none"/>
        <div class="col-12 col-md-8">
            <div class="row">
                <div class="col-6 col-md-3 form-group">
                    <label class="my-0">Fecha de Emisión</label>
                    <input class="form-control form-control-sm" type="text" id="feme" />
                </div>
                <div class="col-6 col-md-3 form-group">
                    <label class="my-0">Serie</label>
                    <input type="text" class="form-control form-control-sm" id="sere" data-val="true" />
                    <span id="esere" class="invalid-feedback"></span>
                </div>
                <div class="col-6 col-md-3 form-group">
                    <label class="my-0">Número</label>
                    <input type="text" class="form-control form-control-sm" id="nume" data-val="true" />
                    <span id="enume" class="invalid-feedback"></span>
                </div>
                <div class="col-6 col-md-3 form-group">
                    <label class="my-0">Forma de Pago</label>
                    <select id="fpe" class="form-control form-control-sm" data-val="true">
                    </select>
            ...
            <div class="row">
                <div class="col-lg-6 col-12 form-group">
                    <label class="my-0">
                        Dirección de Partida
                        <button id="ndpe" class="ml-2 btn btn-secondary btn-sm bg-transparent border-0 text-black-50" style="margin-top: -5px !important">[+ Nuevo]</button>
                    </label>
                    <select id="dpare" class="form-control form-control-sm" data-val="true">
                        <option value=""></option>
                    </select>
                ...
                <div class="col-lg-3 col-6 form-group">
                    <label class="my-0">Vendedor</label>
                    <select id="vene" class="form-control form-control-sm" data-val="true">
                        <option value=""></option>
                    </select>
                ...
                <div class="col-lg-3 col-6 form-group">
                    <label class="my-0">Contacto</label>
                    <select id="contace" class="form-control form-control-sm" data-val="true">
                        <option value="0"></option>
                    </select>
            ...
            <div class="row">
                <div class="col-lg-3 col-6 form-group">
                    ...
                    <select id="clie" class="form-control form-control-sm" data-val="true">
                        <option value=""></option>
                    </select>
                ...
                <div class="col-lg-3 col-6 form-group">
                    <label class="my-0">Transportista</label>
                    <select id="tranpe" class="form-control form-control-sm" data-val="true">
                        <option value=""></option>
                    </select>
                ...
                <div class="col-lg-3 col-6 form-group">
                    <label class="my-0">RUC / Facturar</label>
                    <input type="text" class="form-control form-control-sm" id="cruce" data-val="true" />
                    <span id="ecruce" class="invalid-feedback"></span>
                </div>
                <div class="col-lg-3 col-6 form-group">
                    <label class="my-0">Dirección de Llegada</label>
                    <select id="dllege" class="form-control form-control-sm" data-val="true">
                        <option value=""></option>
                    </select>
                ...
                <div class="col-lg-3 col-6 form-group">
                    <label>Punto de Entrega</label>
                    <select id="pune" class="form-control form-control-sm" data-val="true">
                        <option value=""></option>
                    </select>
        ...
        <div class="col-12 col-md-4 border-md-left">
            <div class="row">
                ...
                <div class="col-12 col-lg-6  form-group">
                    <input type="text" class="form-control form-control-sm" id="lincree" readonly="readonly" />
                </div>
                <div class="col-12 col-lg-6 ">
                    <label class="my-0 my-md-auto">Pendiente de Pago</label>
                </div>
                <div class="col-12 col-lg-6  form-group">
                    <input type="text" class="form-control form-control-sm" id="penpage" readonly="readonly" />
                </div>
                <div class="col-12 col-lg-6 form-group">
                    <label class="my-0 my-md-auto">Ultimo Pago</label>
                    <input type="text" class="form-control form-control-sm" id="ultpage" readonly="readonly" />
                </div>
                <div class="col-12 col-lg-6 form-group">
                    <label class="my-0 my-md-auto">Ultimo día de Pago</label>
                    <input type="text" class="form-control form-control-sm" id="ultdiapage" readonly="readonly" />
                </div>
            </div>
            <div class="col-12 table-responsive">
                <div id="listpe"></div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="row">
                        <div class="col-12 form-group mb-0">
                            <button class="mb-1 btn btn-primary btn-sm" id="regpage">Registro Pago</button>
                            <button class="mb-1 btn btn-primary btn-sm" id="reppdfe">Reporte PDF</button>
                            <button type="button" class="mb-1 btn btn-primary btn-sm" id="expexce" onclick="exportarRV();">Exportar Excel</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="stickyTable col-12 table-responsive table-responsive-sm">
            <table class="table table-sm table-bordered table-hover table-striped" id="productose">
                <thead>
                    <tr>
                        <th style="display: none">Id</th>
                        <th class="text-center">Código</th>
    ...
    <div class="row text-right">
        ...
        <div class="col-md-2 col-6 form-group">
            <input type="text" class="form-control form-control-sm" id="totalle" readonly="readonly"/>
        </div>
    </div>
    <div class="row">
        <div class="col-md-2 col-6 my-2 custom-control-inline">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row align-self-center">
                        ...
                        <div class="col-md-2 form-group text-right" style="padding-top: 20px;">
                            <label>IGV</label>
                        </div>
                    </div>
                    <div class="row align-self-center">
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/regvtasanti.js"></script>
</asp:Content>
