<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ReporteVentasPorCliente.aspx.cs" Inherits="SanAlberto.pages.vtas.ReporteVentasPorCliente" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder">Reporte de Ventas Por Cliente
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                <label for="clientesSelect" class="col-md-2 col-form-label">Contacto:</label>
                                <div class="col-md-10">
                                    <select class="form-control select2" id="contSelect">
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group row">
                                <label for="clientesSelect" class="col-md-2 col-form-label">Cliente:</label>
                                <div class="col-md-10">
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <select class="form-control select2" id="serieVal"></select>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                  <!--  <input type="text" id="numeroVal" placeholder="..." class="form-control form-control-sm mb-2 mr-sm-2" />-->
                                    <select class="form-control select2" id="numeroVal"></select>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-2 align-self-center">
                    <button class="form-control btn bg-gradient-primary text-white mb-1 mb-md-2 pr-1 pl-1" type="button" id="btnFiltro">
                        <span class="mr-1 fa fa-search"></span>
                        Filtrar
            ...
            <div class="row">
                <div id="tblRepVtas" class="col-12 table-responsive stickyTable" style="height: 50vh; width: 100%">
                    <table class="table table-hover table-sm">
                        <thead>
                            <tr>
                                <th>VENTA FINAL/VENTA ANTICIPADA</th>
                                <th>SERIE</th>
                                <th>NUMERO</th>
                                <th>CLIENTE</th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/repvtasxcliente.js"></script>
</asp:Content>
