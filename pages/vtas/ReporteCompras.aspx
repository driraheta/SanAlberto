<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ReporteCompras.aspx.cs" Inherits="SanAlberto.pages.vtas.ReporteCompras" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class="mb-0 text-gray-900 text-uppercase font-weight-bolder"><i class="fa fa-edit"></i>&nbsp;Reportes de compras (Productos/Servicios)
    ...
    <div class="card">
            ...
            <div class="row">
                <div class="col-10 col-m-10">
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="op" class="mr-sm-2">Producto/Servicio</label>
                            <select class="form-control select2" id="nomp">
                                <option value="0">--Seleccionar--</option>
                            </select>
                        </div>
                        <div class="col">
                            <label for="edo" class="mr-sm-2">Estado</label>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <div id="tblRepCompras" class="col-12 table-responsive stickyTable" style="height: 50vh; width: 100%">
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/reportecompras.js"></script>
</asp:Content>
