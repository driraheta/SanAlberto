<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="embalaje.aspx.cs" Inherits="SanAlberto.pages.cats.embalaje" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder">Mantenimiento de Embalaje
    ...
    <div class="row justify-content-center">
                ...
                <div class="card-body">
                    <div class="row justify-content-center" id="forma">
                        <div class="col-12 my-1">
                            ...
                            <input type="text" class="form-control form-control-sm" id="emb" data-val="true" />
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="stickyTable col-11 col-md-7 table-responsive table-responsive-sm ">
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/emba.js"></script>
</asp:Content>
