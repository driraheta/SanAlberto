<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="PuntoEntrega.aspx.cs" Inherits="SanAlberto.pages.cats.PuntoEntrega" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder">Mantenimiento de Puntos de Entrega
                ...
                <div class="card-body">
                    <div class="row justify-content-center" id="forma">
                        <div class="col-12 my-1">
                            ...
                            <input type="text" class="form-control form-control-sm" id="punentre" data-val="true" />
                            <span id="epunentre" class="invalid-feedback"></span>
                        </div>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/puntoentrega.js"></script>
</asp:Content>
