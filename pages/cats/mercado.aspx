<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="mercado.aspx.cs" Inherits="SanAlberto.pages.cats.mercado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder">Mantenimiento de Mercado
    ...
    <div class="row justify-content-center">
                ...
                <div class="card-body">
                    <div class="row justify-content-center" id="forma">
                        <div class="col-12 my-1">
                            <label class="my-0 mr-1">Descripción:</label>
                            <input type="text" class="form-control form-control-sm mr-1" id="merc" data-val="true" />
        ...
        <div class="col-md-4 col-12 col-sm-8">
            <div class="row">
                <div class="stickyTable offset-md-1 col-md-10 table-responsive table-responsive-sm ">
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/merc.js"></script>
</asp:Content>
