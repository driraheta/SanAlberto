<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="conpago.aspx.cs" Inherits="SanAlberto.pages.cats.conpago" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder">Mantenimiento de Condiciones de Pago
                ...
                <div class="card-body">
                    <div class="row justify-content-center" id="forma">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control form-control-sm" id="cp" data-val="true" />
                            <span id="ecp" class="invalid-feedback"></span>
                        </div>
                        <div class="col-12">
                            <label>No. Días</label>
                            <input type="text" class="form-control form-control-sm numeros" id="nodia" data-val="true" />
                            <span id="enodia" class="invalid-feedback"></span>
                        </div>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/conpago.js"></script>
</asp:Content>
