<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="FormaPago.aspx.cs" Inherits="SanAlberto.pages.cats.FormaPago" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder">Mantenimiento de Formas de Pago
                ...
                <div class="card-body">
                    <div class="row justify-content-center" id="forma">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control form-control-sm" id="fp" data-val="true" />
                            <span id="efp" class="invalid-feedback"></span>
                        </div>
                        <div class="col-12">
                            <label>Nro. de Días</label>
                            <input type="text" class="form-control form-control-sm numeros" id="nd"/>
                            <span id="end" class="invalid-feedback"></span>
                        </div>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/formapago.js"></script>
</asp:Content>
