<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ConfigSistema.aspx.cs" Inherits="SanAlberto.pages.cats.ConfigSistema" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder">Datos Sistema
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row justify-content-center" id="forma">
                        ...
                        <div class="col-12">
                            <label>Correo</label>
                            <input type="text" class="form-control form-control-sm" id="correo" data-val="true" />
                            <span id="ecorreo" class="invalid-feedback"></span>
                        </div>
                        <div class="col-12">
                            <label>Password</label>
                            <input type="password" class="form-control form-control-sm" id="pass" data-val="true" />
                            <span id="epass" class="invalid-feedback"></span>
                        </div>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/configsis.js"></script>
</asp:Content>
