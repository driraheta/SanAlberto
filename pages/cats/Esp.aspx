<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Esp.aspx.cs" Inherits="SanAlberto.pages.cats.Esp" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder">Mantenimiento de Especies
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row justify-content-center" id="forma">
                        <div class="col-12">
                            <label>Especie</label>
                            <input type="text" class="form-control form-control-sm" id="esp" data-val="true" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/esp.js"></script>
</asp:Content>
