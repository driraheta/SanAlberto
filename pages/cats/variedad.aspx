<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="variedad.aspx.cs" Inherits="SanAlberto.pages.cats.variedad" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder">Mantenimiento de Variedades
                ...
                <div class="card-body">
                    <div class="row justify-content-center" id="forma">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control form-control-sm" id="var" data-val="true" />
                            <span id="evar" class="invalid-feedback"></span>
                        </div>
                        <div class="col-12 my-1">
                            <label>Especie</label>
                            <select id="esp" class="form-control form-control-sm" data-val="true">
                                <option value=""></option>
                            </select>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/var.js"></script>
</asp:Content>
