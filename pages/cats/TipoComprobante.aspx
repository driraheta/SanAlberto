<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="TipoComprobante.aspx.cs" Inherits="SanAlberto.pages.cats.TipoComprobante" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder"><i class="fa fa-tag"></i>&nbsp;MANTENIMIENTO DE SERIES
                ...
                <div class="card-body">
                    <div class="row" id="forma">
                        <div class="offset-md-2 col-md-6 col-6 form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="desc" data-val="true" maxlength="80" />
                            <span id="edesc" class="invalid-feedback"></span>
                        </div>
                        <div class="offset-md-2 col-md-6 col-6 form-group">
                            <label>Serie</label>
                            <input type="text" class="form-control form-control-sm" id="ser" data-val="true" maxlength="10" />
                            <span id="eser" class="invalid-feedback"></span>
                        </div>
                        <div class="offset-md-2 col-md-6 col-6 form-group">
                            <label>Número</label>
                            <input type="text" class="form-control form-control-sm numeros" id="num" data-val="true" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/tipocomp.js"></script>
</asp:Content>
