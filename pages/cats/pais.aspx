<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="pais.aspx.cs" Inherits="SanAlberto.pages.cats.pais" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder"><i class="fa fa-tag"></i>&nbsp;Mantenimiento de Paises
                ...
                <div class="card-body">
                    <div class="row" id="forma">
                        <div class="offset-md-2 col-md-6 col-6 form-group">
                            <label>Nombre</label>
                            <input type="text" class="form-control form-control-sm" id="pai" data-val="true" />
                            <span id="epai" class="invalid-feedback"></span>
                        </div>
                        <div class="offset-md-2 col-md-6 col-6 form-group">
                            <label>Clave</label>
                            <input type="text" class="form-control form-control-sm" id="cla" data-val="true" />
                            <span id="ecla" class="invalid-feedback"></span>
                        </div>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/pais.js"></script>
</asp:Content>
