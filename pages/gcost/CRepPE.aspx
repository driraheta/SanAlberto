<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="CRepPE.aspx.cs" Inherits="SanAlberto.pages.gcost.CRepPE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class="mb-0 text-gray-900 text-uppercase font-weight-bolder"><i class="fa fa-shopping-cart"></i>&nbsp;Costos de Reparto de Punto de Entrega
    ...
    <div id="lista" class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 table-responsive">
                    <div id="creppe" class="stickyTable table-responsive" style="height: 50vh;"></div>
                </div>
            </div>
        </div>
    </div>
     ...
     <div id="datos" class="card">
                <div class="card-header">
                    <h5 class="card-title">Registro de Costo de Reparto</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/creppe.js"></script>
</asp:Content>
