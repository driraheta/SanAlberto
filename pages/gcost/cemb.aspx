<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="cemb.aspx.cs" Inherits="SanAlberto.pages.gcost.cemb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class="mb-0 text-gray-900 text-uppercase font-weight-bolder"><i class="fa fa-boxes"></i>&nbsp;Costos de Embalaje
    ...
    <div id="datos" class="card" style="display:none;">
        <div class="card-header">
            <h5 class="card-title">Registro de Costo Embalaje</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <div class="form" id="fletem">
                        <div class="form-group row">
                            <label class="col-4">Tipo de Embalaje</label>
                            <div class="col-8">
                                <select id="emb" class="form-control form-control-sm" data-val="true">
                                    <option value=""></option>
                                    <option value="1">Bandeja</option>
                                    <option value="2">Film</option>
                                    <option value="3">Sticker</option>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/cemba.js"></script>
</asp:Content>
