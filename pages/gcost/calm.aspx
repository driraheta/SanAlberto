<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="calm.aspx.cs" Inherits="SanAlberto.pages.gcost.calm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class="mb-0 text-gray-900 text-uppercase font-weight-bolder"><i class="fa fa-warehouse"></i>&nbsp;Costos de Almacenaje
            ...
            <div class="row">
                <div class="col-10 col-m-10">
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="filtroTipo" class="mr-sm-2">Tipo</label>
                            <select id="filtroTipo" class="form-control form-control-sm mb-2 mr-sm-2 select">
                                <option value="0" data-select2-id="select2-data-2-7xaw">Todos</option>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 table-responsive">
                    <div id="costos" class="stickyTable table-responsive" style="height: 50vh;"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="datos" class="card" style="display: none;">
                <div class="card-header">
                    <h5 class="card-title">Registro de Costo Almacenaje</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="form" id="fletem">
                                <div class="form-group row">
                                    <label class="col-4">Tipo de Almacenaje</label>
                                    <div class="col-8">
                                        <select id="tipa" class="form-control form-control-sm" data-val="true">
                                            <option value=""></option>
                                            <option value="1">Costo Almacenaje</option>
                                            <option value="2">Desestiba y Estiba</option>
                                            <option value="3">Refacturacion</option>
                                        </select>
                                        <span id="etipa" class="invalid-feedback"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/calmacen.js"></script>
</asp:Content>
