<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ReporteConcarCompras.aspx.cs" Inherits="SanAlberto.pages.rprts.ReporteConcarCompras" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class=" mb-0 text-gray-900 text-uppercase font-weight-bolder">Reporte Concar Compras
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div id="tblRepConcarCompras" class="col-12 table-responsive stickyTableConcar" style="height: 62vh; width: 100%">
                    <table class="table table-hover ">
                        ...
                        <tbody class="text-center justify-content-center">
                            <tr idcompra="idCompra" idconcarcompra="idConcarCompra" class="text-center justify-content-center">
                                <td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/repconcarcompras.js"></script>
</asp:Content>
