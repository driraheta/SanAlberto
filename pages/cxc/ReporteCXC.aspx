<%@ Page Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ReporteCXC.aspx.cs" Inherits="SanAlberto.pages.cxc.ReporteCXC" %>
    ...
    <div class="row">
        <div class="col-12 col-sm-10">
            <div class="d-sm-flex align-items-center justify-content-between mb-2 mt-2">
                <h5 class="mb-0 text-gray-900 text-uppercase font-weight-bolder"><i class="fa fa-edit"></i>&nbsp;Reportes de Cuentas por Cobrar
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <label for="serieVal" class="mr-sm-2">Serie</label>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <select class="form-control" id="bcli"></select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <label for="numeroVal" class="mr-sm-2">Numero</label>
                                    <input type="text" class="form-control form-control-sm mb-2 mr-sm-2" placeholder="Numero" id="numeroVal">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="col-12" style="margin-top: 3px;">
                                    ...
                                    <br>
                                    <input type="radio" id="cobdiario" name="tiporep" value="4">
                                    <label for="cxccd">Cobranza Diaria</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="/assets/global/pages/js/reportecxc.js"></script>
</asp:Content>
