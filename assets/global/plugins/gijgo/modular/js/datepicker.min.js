...
gj.datepicker.methods = {
    ...
    change: function ($datepicker, $calendar, data, date) {
        ...
        $calendar.attr("fecha", fecha);
        $datepicker.val(value);
        $datepicker.fecha(date);
        //$(this).attr("fecha", date);
...
gj.datepicker.widget = function ($element, jsConfig) {
    ...
    self.fecha = function (fecha) {
        return methods.fecha(this, fecha);
    };
    /** Open the calendar.
     */
    self.open = function () {
